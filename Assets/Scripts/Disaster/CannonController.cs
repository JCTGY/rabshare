...
public class CannonController : MonoBehaviour
{
    ...
    public float forceInNewtons = 600f;
    ...
    private void Start()
    {
        ...
        forceInNewtons += forceInNewtons * GameMaster.DisasterIncreaseRatio * GameMaster.CurrentDisasterLevel;
        shotsPerSecond += shotsPerSecond * GameMaster.DisasterIncreaseRatio * GameMaster.CurrentDisasterLevel;
    }
